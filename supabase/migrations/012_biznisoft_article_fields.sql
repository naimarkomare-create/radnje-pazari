alter table public.biznisoft_articles add column if not exists cat_no text;
alter table public.biznisoft_articles add column if not exists unit text;
alter table public.biznisoft_articles alter column raw set default '{}'::jsonb;
