...
import { deleteTaskPhoto } from "@/app/admin/zadaci/actions";

export function DeleteTaskPhotoButton({ assignmentId }: { assignmentId: string }) {
  ...
  async function onDelete() {
    ...
    setLoading(true);
    setMessage("");
    const result = await deleteTaskPhoto(assignmentId);
